...
part 'services/wallet_repository.transaction.dart';
part 'services/wallet_repository.unspent.dart';
part 'services/wallet_repository.wallet.dart';
part 'services/wallet_repository.withdraw.dart';
part 'store/wallet_actions.balance.dart';
part 'store/wallet_actions.dart';
part 'store/wallet_actions.management.dart';
part 'store/wallet_actions.transaction.dart';
part 'store/wallet_actions.unspent.dart';
